...
class Dhl
  class Pickup
    ...
    def self.deprication_notice(meth, m)
      messages = {
        :metric => "Method replaced by Dhl::Pickup#metic_measurements!(). I am now setting your measurements to metric",
        :us     => "Method replaced by Dhl::Pickup#us_measurements!(). I am now setting your measurements to US customary",
      }
